...
import '/component/cart_product/cart_product_widget.dart';
                      ...
                      return Column(
                        ...
                        children:
                          ...
                          return CartProductWidget(
                            key: Key(
                                'Key3ug_${productsIndex}_of_${products.length}'),
                            ref: productsItem,
                          );
                        }),
                      );
                            ...
                            children: [
                              RichText(
                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      text: FFAppState().totalCart.toString(),
                                ...
                                onPressed: () async {
                                  if (_model.textController.text != null &&
                                    ...
                                    await OrdersRecord.collection.doc().set({
                                      ...
                                      ...mapToFirestore(
                                        {
                                          'orderRef': FFAppState().Cart,
                                        },
                                      ),
                                    });
                                    triggerPushNotification(
                                      notificationTitle: 'Cafe Ordering System',
                                      notificationText:
