...
import 'add_products_model.dart';
export 'add_products_model.dart';
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      controller: _model.textController2 ??=
                          TextEditingController(
                        text: containerProductsRecord.price.toString(),
                      ),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        if (_model.uploadedLocalFile1 != null &&
                          ...
                          await widget!.ref!.update(createProductsRecordData(
                          ...
                          await widget!.ref!.update(createProductsRecordData(
                            ...
                            price: double.tryParse(_model.textController2.text),
                            description: _model.textController3.text,
                            img: containerProductsRecord.img,
                          ));
                        }
